...
const EMAILJS_TEMPLATE_ID = 'template_7he0zic';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // PDF Button Handlers — buka Portofolio_Creative.pdf di tab baru
        const pdfPath = 'assets/Portofolio_Creative.pdf';
        const openPortfolioPDF = (e) => {
            e.preventDefault();
        ...
        if (pdfBtn) pdfBtn.addEventListener('click', openPortfolioPDF);
        if (navbarPdfBtn) navbarPdfBtn.addEventListener('click', openPortfolioPDF);
    });
